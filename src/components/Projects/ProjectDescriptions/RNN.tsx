    ...
    return (
        <>
            <p className="project-body">
                ...
                backpropagation through time for next-word
                prediction, analyzing hidden state dynamics and visualizing
                cell states to interpret how the model retained and
                processed contextual information across sequences.
            </p>
